...
def main():
    ...
    with torch.no_grad():
        for request in tqdm.tqdm(requests):
            ...
            # 修改了，增加了输入的最大长度限制，显式启用截断
            input_ids = tokenizer(prompt, add_special_tokens=False, max_length=2048, truncation=True, return_tensors='pt').input_ids.to(model.device)
